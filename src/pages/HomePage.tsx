          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-medium text-[var(--text-secondary)]">Computer Science Student & Creative Developer</span>
              </motion.div>
              ...
              >
                ...
                Actively honing my skills in <span className="text-[var(--accent-primary)]">web development</span> and <span className="text-[var(--accent-third)]">painting</span>, I aspire to create
            ...
            >
              ...
              >
                ...
                <div className="absolute -top-6 -left-6 w-16 h-16 bg-[var(--accent-third)]/10 backdrop-blur-sm rounded-full border border-[var(--accent-third)]/20 animate-pulse-glow" style={{ animationDelay: '1s' }}></div>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4 font-display">Web Development</h3>
                <p className="text-[var(--text-secondary)] leading-relaxed">
                  I build modern, responsive websites and web applications using React, Next.js, and other cutting-edge technologies.
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4 font-display">UI/UX Design</h3>
                <p className="text-[var(--text-secondary)] leading-relaxed">
                  I create intuitive and visually appealing user interfaces and experiences that engage users and achieve business goals.
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4 font-display">Digital Art</h3>
                <p className="text-[var(--text-secondary)] leading-relaxed">
                  I express my creativity through digital art and traditional painting, exploring various techniques and styles.
                </p>
              </motion.div>
            </div>
          </motion.div>
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="marquee relative">
          <div className="marquee-content flex gap-12 items-center">
            {['React', 'Next.js', 'TypeScript', 'Node.js', 'Tailwind CSS', 'MongoDB', 'GraphQL', 'Framer Motion', 'Figma'].map((tech, index) => (
              <div key={index} className="flex items-center px-4 py-2 bg-[var(--bg-secondary)] rounded-lg border border-[var(--border-color)] shadow-sm">
                <span className="text-lg font-medium">{tech}</span>
              </div>
            ))}
            {['React', 'Next.js', 'TypeScript', 'Node.js', 'Tailwind CSS', 'MongoDB', 'GraphQL', 'Framer Motion', 'Figma'].map((tech, index) => (
              <div key={index + 9} className="flex items-center px-4 py-2 bg-[var(--bg-secondary)] rounded-lg border border-[var(--border-color)] shadow-sm">
                <span className="text-lg font-medium">{tech}</span>
              </div>
            ))}
          </div>
