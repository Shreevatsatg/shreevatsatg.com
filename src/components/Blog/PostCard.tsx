  ...
  return (
    ...
    >
      <div className="p-6 flex-1 flex flex-col">
        <p className="text-slate-400 text-sm mb-2 font-light">{post.date}</p>
        ...
        <Link to={`/blog/${post.slug}`} className="flex items-center gap-2 text-slate-200 font-medium group-hover:text-white transition-colors duration-300 mt-auto">
          <span>Read More</span>
